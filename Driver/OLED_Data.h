...
extern const uint8_t Emoji_Ashamed[];
extern const uint8_t Emoji_Cry[];
extern const uint8_t Emoji_Cute[];
extern const uint8_t Emoji_Happy[];
extern const uint8_t Emoji_Kiss[];
